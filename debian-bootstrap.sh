...
sudo apt-get update
sudo apt-get install -y build-essential libncurses-dev git libgmp3c2 libgmp3-dev zlib1g-dev libedit2 libedit-dev freeglut3-dev libglu1-mesa-dev apt-get install libglib2.0-dev libcairo2-dev libpango1.0-dev libgtk2.0-dev zip
